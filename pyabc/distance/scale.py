...
def check_io(fun):
    ...
    def checked_fun(samples: np.ndarray, **kwargs):
        ...
        if 's_ids' in kwargs:  # noqa: SIM102
...
@check_io
def median_absolute_deviation(*, samples: np.ndarray, **kwargs) -> np.ndarray:  # noqa: ARG001
    """
...
@check_io
def mean_absolute_deviation(*, samples: np.ndarray, **kwargs) -> np.ndarray:  # noqa: ARG001
    """
...
@check_io
def standard_deviation(*, samples: np.ndarray, **kwargs) -> np.ndarray:  # noqa: ARG001
    """
...
@check_io
def bias(*, samples: np.ndarray, s0: np.ndarray, **kwargs) -> np.ndarray:  # noqa: ARG001
...
@check_io
def span(*, samples: np.ndarray, **kwargs) -> np.ndarray:  # noqa: ARG001
    """Compute the difference of largest and smallest sample point."""
    return np.nanmax(samples, axis=0) - np.nanmin(samples, axis=0)


@check_io
def mean(*, samples: np.ndarray, **kwargs) -> np.ndarray:  # noqa: ARG001
    """Compute the mean."""
    return np.nanmean(samples, axis=0)


@check_io
def median(*, samples: np.ndarray, **kwargs) -> np.ndarray:  # noqa: ARG001
    """Compute the median."""
