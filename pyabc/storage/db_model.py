...
class ABCSMC(Base):
    ...
    def __repr__(self):
        return (
            "<ABCSMC(id={id}, start_time={start_time}, "
...
class Population(Base):
    ...
    def __repr__(self):
        return (
            "<Population(id={id}, abc_smc_id={abc_smc_id}, t={t}) "
            "nr_samples={nr_samples} eps={eps} "
            "population_end_time={population_end_time}>".format(
                id=self.id,
                abc_smc_id=self.abc_smc_id,
                t=self.t,
...
class Model(Base):
    ...
    def __repr__(self):
        return "<Model id={} population_id={} m ={} name={} p_model={}>".format(
            self.id, self.population_id, self.m, self.name, self.p_model
        )
