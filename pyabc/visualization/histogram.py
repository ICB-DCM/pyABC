...
def plot_histogram_2d_lowlevel(
    ...
    **kwargs
    ...
    # plot
    ax.hist2d(x=df[x], y=df[y], range=range_, weights=w, density=True, **kwargs)
    if refval is not None:
...
def plot_histogram_matrix(
    ...
    **kwargs
    ...
    return plot_histogram_matrix_lowlevel(df, w, size, refval, refval_color, **kwargs)
    ...
    **kwargs
    ...
    for i in range(0, n_par):
        ...
        plot_histogram_1d_lowlevel(
            df, w, y_name, ax=ax, refval=refval, refval_color=refval_color, **kwargs
        )
