...
def plot_sensitivity_sankey(
    ...
    par_trafo: pyabc.util.ParTrafoBase | None = None,
    sumstat: pyabc.sumstat.Sumstat | None = None,
    subsetter: pyabc.sumstat.Subsetter | None = None,
    ...
    scale_weights: dict[int, np.ndarray] | None = None,
    title: str = 'Data-parameter sensitivities',
    width: float | None = None,
    height: float | None = None,
    sumstat_color: Callable[[str], str] | None = None,
    par_color: Callable[[str], str] | None = None,
