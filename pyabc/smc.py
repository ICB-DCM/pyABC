...
class ABCSMC:
    ...
    def new(self, db: str,
        ...
        # return id generated by store_initial_data
        return self.history.id

    def _initialize_dist_and_eps(self, t: int):
        """
        Called once in new() and load(). This function generates a
        ...
        require_initialize is set (unset the respective flags if no
