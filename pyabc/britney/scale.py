...
def mean_absolute_deviation(data, **kwargs):
    ...
    """
    mad = np.nanmean(np.abs(data - np.nanmean(data, axis=0)), axis=0)
    return mad
...
def bias(data, x_0, **kwargs):
    ...
    """
    bias = np.abs(np.nanmean(data, axis=0) - x_0)
    return bias
...
def median_absolute_deviation_to_observation(data, x_0, **kwargs):
    ...
    """
    mado = np.nanmedian(np.abs(data - x_0), axis=0)
    return mado
...
def mean_absolute_deviation_to_observation(data, x_0, **kwargs):
    ...
    """
    mado = np.nanmean(np.abs(data - x_0), axis=0)
    return mado
...
def standard_deviation_to_observation(data, x_0, **kwargs):
    ...
    the observation x_0.
    """
    stdo = np.nanstd(np.abs(data - x_0), axis=0)
    return stdo
