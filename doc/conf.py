...
release = version
import subprocess
result = subprocess.run(["python", "../examples/quickstart.py"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
man_pages = [
    (master_doc, 'pyabc', 'pyABC documentation',
     [author], 1)
]
