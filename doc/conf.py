...
exclude_patterns = ["_build", "**.ipynb_checkpoints", "examples/tmp"]
...
latex_documents = [
    (master_doc, "pyABC.tex", "pyABC Documentation", author, "manual"),
]
...
man_pages = [(master_doc, "pyabc", "pyABC documentation", [author], 1)]
